== Migration notes (March 15, 2024 at 3:42:05 PM AEST)
...
* `qut.model:bdm-client:jar:1.0.0` dependency has been replaced with `${project.groupId}:bonita-eg3-bdm-model:jar:${project.version}`.
